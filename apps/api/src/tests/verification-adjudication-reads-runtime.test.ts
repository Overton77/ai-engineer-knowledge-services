    ...
    expect(() =>
      createVerificationAdjudicationReads({} as never, {
        ...
        VERIFICATION_ADJUDICATION_GRANTS_JSON: JSON.stringify([
          {
            tenantId,
            auditArtifact: { artifactId, digest },
            runKind: "claims",
          },
        ]),
        VERIFICATION_CLAIMS_PROJECTION_GRANTS_JSON: JSON.stringify([
          {
            tenantId,
            ...
            admissions: [
              {
                ...
                transformationArtifactId: artifactId,
        ...
        VERIFICATION_SERVICE_OWNERSHIP_GRANTS_JSON: JSON.stringify([
          {
            ...
            capabilityVersion: "verification-adjudication.v1",
          },
        ]),
