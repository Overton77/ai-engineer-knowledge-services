...
import { StructuredExtractionCapturedReplayService, type StructuredExtractionReplayCapture } from "../packages/application/src/verification/operations/verification-structured-extraction-replay.js";
...
try{
 ...
 const paths=["packages/application/src/verification/operations/verification-structured-extraction-profile.ts","packages/application/src/verification/operations/verification-structured-extraction-replay.ts","packages/application/src/verification/operations/verification-structured-extraction-candidate.ts","scripts/prove-verification-structured-extraction-candidate.ts"];
