...
import {StructuredExtractionExecutionArtifactBuilder,StructuredExtractionPublicationArtifactBuilder} from "../packages/application/src/verification-structured-extraction-publication.js";
...
const custodyPaths=["packages/contracts/src/verification/structured-extraction-publication.ts","packages/application/src/verification-structured-extraction-publication.ts","packages/application/src/verification-structured-extraction-profile.ts","packages/application/src/verification-structured-extraction-replay.ts","packages/application/src/verification-structured-extraction-candidate.ts","packages/persistence/src/verification-structured-extraction-execution.ts","packages/persistence/src/verification-structured-extraction-publication.ts","packages/persistence/src/verification-structured-extraction-lifecycle.ts","../ai-engineer-db-contract/supabase/migrations/20260906031800_verification_structured_extraction_execution.sql","../ai-engineer-db-contract/supabase/migrations/20260906031900_verification_structured_extraction_publication.sql","../ai-engineer-db-contract/supabase/migrations/20260906032000_verification_structured_extraction_source_custody.sql","packages/contracts/src/verification/structured-extraction-result.ts","packages/application/src/verification-structured-extraction-result.ts","packages/persistence/src/postgres.ts","../ai-engineer-db-contract/supabase/migrations/20260906032100_verification_structured_extraction_terminal.sql","../ai-engineer-db-contract/supabase/migrations/20260906032200_verification_structured_extraction_input_custody.sql","../ai-engineer-db-contract/supabase/migrations/20260906032300_verification_structured_extraction_step_membership.sql","../ai-engineer-db-contract/supabase/migrations/20260906032400_verification_structured_extraction_owner_custody.sql","scripts/prove-verification-structured-extraction-terminal.ts"];
