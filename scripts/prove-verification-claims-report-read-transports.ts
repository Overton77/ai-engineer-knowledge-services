...
try{
  ...
  const sourcePaths=["packages/contracts/src/verification/claims-report-reads.ts","packages/application/src/verification-claims-report-reads.ts","packages/persistence/src/verification-claims-report-reads.ts","apps/api/src/verification-claims-report-reads-runtime.ts","apps/api/src/verification-ownership.ts","apps/api/src/server.ts","apps/api/src/index.ts","packages/client-typescript/src/client.ts","apps/cli/src/commands.ts","apps/mcp/src/index.ts","scripts/prove-verification-claims-report-read-transports.ts"];
